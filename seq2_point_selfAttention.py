...
class Seq2Point_selfAttention(Disaggregator):

    def __init__(self, params):
        super(Seq2Point_selfAttention, self).__init__()

        self.MODEL_NAME = "Seq2Point_Self_Attention"
        self.models = OrderedDict()
        self.file_prefix = f"{self.MODEL_NAME.lower()}-temp-weights"
        self.chunk_wise_training = params.get('chunk_wise_training', False)
        self.sequence_length = params.get('sequence_length', 153)
    ...
    def partial_fit(self, train_main, train_appliances, do_preprocessing=True, current_epoch=0, **load_kwargs):
        ...
        print("...............Seq2Point_selfAttention partial_fit running...............")
        if do_preprocessing:
    ...
    def return_network(self):
        model = Self_Attention2(self.sequence_length, 51).to(device)
        return model
